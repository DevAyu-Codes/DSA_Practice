# Welcome to DSA Prctice Folder
## Code Files:
Here's the list of all the files:
1. [StackPractice](StackPractice.java)
2. [QueuePractice](QueuePractice.java)
...
---
## Outputs:
Outputs of all the codes are in [output.md](output.md).